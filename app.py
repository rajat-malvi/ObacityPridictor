...
app.config["MAIL_USERNAME"] = 'your gmail'  # Update with your Gmail email
app.config['MAIL_PASSWORD'] = 'your passwoed'  # Update with your Gmail password
app.config['MAIL_USE_TLS'] = False
app.config['MAIL_USE_SSL'] = True

mail = Mail(app)

def send_email(email, h, w, predicted_classes):
...
def send_email_route():
    ...
    if send_email(email, data['height'], data['weight'], predicted_classes):
        session['email'] = email
        return render_template('index.html')
    else:
